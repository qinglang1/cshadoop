...
public class AppPageLog extends AppBaseLog {
    ...
    private String pageId;          //页面id    dictionary中有
    private String visitIndex;      //访问顺序号，0为第一个页面     dictionary中有
    private String nextPage;        //下一个访问页面，如为空则表示为退出应用的页面   dictionary中有
    private String stayDurationSecs;  //当前页面停留时长    无
